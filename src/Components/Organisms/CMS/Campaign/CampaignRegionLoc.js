import {
  ...
  export default function CampaignRegionLoc({
    selectedBgImg = null,
    regions = [],
              ...
              return (
                ...
                > 
                  <View style={styles.regionNameContainer} >
                    ...
                    {
                     (item?.regionData?.length && item?.isEdit == true) ?
                      <View style={{ flexDirection: "row" }}>
                        <Pressable style={{backgroundColor:'#fff',padding:2,borderRadius:7,justifyContent:'center',alignItems:'center' }} 
                          onPress={() => {
                        ...
                        <Pressable style={{ marginLeft: 15,backgroundColor:'#fff',padding:2,borderRadius:7,justifyContent:'center',alignItems:'center' }} 
                          onPress={()=>{
