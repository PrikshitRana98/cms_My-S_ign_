    ...
    return (
      ...
      >
        {item?.mediaDetail != null && (
          <>
            <Image
              source={{ uri: item?.mediaDetail[0].thumbnailUrl }}
              style={Styles.imageStyle}
            />
            <Image source={InfoImage} style={Styles.infoStyle} />
            <AppText
              style={[Styles.videoName, { color: "black", fontSize: 14 }]}
            >
        ...
        <View style={Styles.mainContainer}>
          <View style={Styles.campaignContainerView}>
            ...
            {campdata.length > 0 ? (
              ...
              <AppText style={{ margin: 15, color: "black", fontSize: 14 }}>
                No Campaign Found
              </AppText>
            )}
            {campdata.length > 0 ? (
...
export default React.memo(SelectCampaignModal);
