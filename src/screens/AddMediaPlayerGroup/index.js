...
const AddMediaPlayerGroup = ({navigation}) => {
  ...
  const btnGetMPGroup=()=>{
    ...
    const succussCallBack = async (response) => {
      ...
      if (response.code ==200) {
        ...
        // Alert.alert('Succesvjs!', response.message, [
        //   {text: 'Okay', onPress: () => {
        //     navigation.goBack()
        //   }},
        // ]);
   ...
   setIsLoading(true);
    ...
    mediaGroupManagerService.addMPGroup(
      postData,
      succussCallBack,
      failureCallBack
    );
  ...
  return (
    <View style={Styles.mainContainer}>
      ...
      <ClockHeader />
      {successModal && <SuccessModal Msg={"Device group added successfully"} onComplete={onComplete} />}
...
export default AddMediaPlayerGroup;
