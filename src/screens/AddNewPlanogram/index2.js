...
//     const ind=index
//     console.log("Remove Campaign--->",index)
//     if (campaignType == 0) {
//       return (
//         <View
//           style={{
...
//             marginVertical:5,}}
//         >
//           <Text style={{color:"black",height:40,textAlignVertical:"center"}} numberOfLines={1}>
//           {item.campaignTitle}
//           </Text>
//           <TouchableOpacity
...
//       return (
//         <View
//           style={{width:Dimensions.get("window").width*0.8,backgroundColor:"white",borderWidth:1,borderRadius:10,paddingHorizontal:16 ,marginVertical:5}}
//         >
//           <Text style={{width:Dimensions.get("window").width*0.9,color:"black",height:40,textAlignVertical:"center"}} numberOfLines={1}>
...
//                     Selected Camapign Strings
//                   </AppText>
//                   <FlatList
//                     scrollEnabled={false}
//                     numColumns={1}
//                     data={state.campaignString.filter((item)=>state.selectedCampaignString.includes(item.campaignStringId))}
//                     renderItem={RemoveCampaign}
//                   />
//                 </>
//               )}
